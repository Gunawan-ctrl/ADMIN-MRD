<template>
  <q-layout view="lHh Lpr lFf">
    <q-header class="bg-white text-indigo-10">
      <q-toolbar class="q-pt-sm">
        ...
        <div class="row q-gutter-md">
          ...
          <q-btn-dropdown flat size="md" icon="account_circle" label="Gunawan">
    ...
    <q-drawer v-model="leftDrawerOpen" show-if-above>
      <q-card class="card q-ma-sm flex text-indigo-10 text-subtitle2">
        <q-item>
          ...
          <q-item-section>
            <q-item-label>PT META REKSA DIGITAL</q-item-label>
            <q-badge color="blue" class="q-mt-xs" style="width: 100px">
      ...
      <q-card class="my-card q-mx-sm q-mt-md" style="height: auto">
        <q-list>
          ...
          >
            ...
            <q-item-section> Input Produk </q-item-section>
          </q-item>
          ...
          <q-item
            ...
            class="navigation-item text-indigo-10"
            clickable
            :to="{ name: 'inputKategori' }"
            v-ripple
          >
            <q-item-section avatar>
              <q-icon name="plagiarism" />
            </q-item-section>
            <q-item-section> Input Kategori </q-item-section>
          </q-item>
          ...
          >
            <q-item
              active-class="tab-active"
              class="navigation-item text-indigo"
              exact
              :to="{ name: 'all-gallery' }"
              clickable
              v-ripple
            >
              ...
              <q-item-section> All Gallery </q-item-section>
            </q-item>
            ...
            >
              ...
              <q-item-section> Add Gallery </q-item-section>
            </q-item>
          </q-expansion-item>
      ...
      <q-card
        class="card-footer q-ma-sm q-mt-md flex text-indigo-10 text-subtitle2"
      >
        <q-item>
          <q-item-section avatar>
